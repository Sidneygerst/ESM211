...
The equilibium is unstable at P = 1. When there is one hunter or less, there is no non-zero equilibrium that is different than the carrying capacity. There is not enough hunting pressure to control the population below the carrying cpacity at this P. 

C. 

If these are the equilibrium equations, I don't understand why 
