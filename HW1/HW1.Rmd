...
grizzly_ttest <- t.test()



```

Based on a linear regression, the population of grizzly bears decreases 0.7576 bears per year between the years 1969 and 1978. This model has significant evidence that there is predictability (S = 2.469, p = 0.023). This is a slower decline than the previous ten years.  
...
Starting in the year 1979, the trend in grizzly bear population switches from decreasing to increasing. The only the females with cubs are counted in this analysis, so it is safe to say that keeping the dump closed has a positive effect on the female bear population. 